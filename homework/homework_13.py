...
def animal_sound(animal: Animal):
    animal.make_sound()
    # Это полиморфизм потому что метод make_sound() есть у всех обьектов, но работает он у каждого по разному
...
a = Animal()
# Класс Animal() абстрактный и его создать напрямую нельзя
